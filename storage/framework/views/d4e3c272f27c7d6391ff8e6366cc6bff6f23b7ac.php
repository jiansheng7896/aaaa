...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="<?php echo e(URL::asset('/')); ?>css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
...
<body class="gray-bg">
    <div class="middle-box text-center animated fadeInDown">
        <h1>403</h1>
        <h3 class="font-bold">您没有权限访问该页面！</h3>
    </div>
